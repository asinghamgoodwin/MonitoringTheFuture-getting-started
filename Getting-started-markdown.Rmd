...
Here, I'm just trying to get those 18 numbers in Table 5 from my data. It looks like sometiems the `NA`s should be in the denominator, and other times they shouldn't....
```{r counts, warning = FALSE, message = FALSE}
been_drunk = all_three_grades_and_years %>% 
  group_by(., year, grade) %>% 
  count(., alc_drunk_lifetime)
been_drunk
```
